...
public class ConnectAndQueryDB {
	...
	public static void main(String[] args) throws NamingException, SQLException {
		...
		try {
			...
			String insertAlgorithme = "INSERT INTO algorithme (idAlgorithme, nom, description) VALUES \n"
					+ "(1, 'Algorithme1', 'AA'),\n"
					+ "(2, 'Algorithme2', 'BB'),\n"
					+ "(3, 'Algorithme3', 'CC'),\n"
					+ "(4, 'Algorithme4', 'DD'),\n"
			...
			String insertImage = "INSERT INTO image (idImage, nom, lienImage) VALUES \n"
					+ "(1, 'Image1', 'lien1'),\n"
					+ "(2, 'Image2', 'lien2'),\n"
					+ "(3, 'Image3', 'lien3'),\n"
					+ "(4, 'Image4', 'lien4'),\n"
			...
			String insertCampagne = "INSERT INTO campagne (idCampagne, nom, description) VALUES \n"
					+ "(1, 'Campagne1', 'AA'),\n"
					+ "(2, 'Campagne2', 'BB'),\n"
					+ "(3, 'Campagne3', 'CC'),\n"
					+ "(4, 'Campagne4', 'DD'),\n"
